...
private:
    ...
    const int dollar_part(double amount) const
    {
...
Money operator+(const Money &amount_1, const Money &amount_2)
{
...
const Money operator-(const Money &amount_1, const Money &amount_2)
{
    return Money(0, 0);
}
const bool operator==(const Money &amount_1, const Money &amount_2)
{
