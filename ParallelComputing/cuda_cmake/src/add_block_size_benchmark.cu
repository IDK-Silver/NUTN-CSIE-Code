...
void print_usage(const char* program) {
    std::cout << "Usage:\n"
              ...
              << "This target compares CPU sequential with CUDA block sizes:\n"
...
int main(int argc, char** argv) {
    ...
    std::cout << std::left << std::setw(24) << "Version" << std::setw(22)
              << "<<<grid, block>>>" << std::setw(15) << "Grid" << std::setw(15)
              << "Block" << std::setw(20) << "Avg time" << "Result\n";
    ...
    std::cout << std::left << std::setw(24) << "CPU sequential" << std::setw(22) << "N/A"
              << std::setw(15) << "N/A" << std::setw(15) << "N/A" << std::setw(20)
    ...
    for (int threads_per_block : test_threads_per_block) {
        ...
        std::cout << std::left << std::setw(24) << "CUDA parallel" << std::setw(22)
                  << launch_config << std::setw(15) << blocks_per_grid << std::setw(15)
                  << threads_per_block << std::setw(20) << (std::to_string(avg_ms) + " ms")
                  << (ok ? "OK" : "FAILED") << '\n';
    }
